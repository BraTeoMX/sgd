    ...
    $(document).ready(function() {
        ...
        function actualizarConteoYListaBecarios(evento_id) {
            if (evento_id) {
                // Actualizar conteos
                $.ajax({
                    url: '{{ route("eventosActualizacion.obtenerRegistrosPorEventoConRegistroConfirmacion") }}',
                    type: 'GET',
                ...
                $.ajax({
                    url: '{{ route("eventosActualizacion.obtenerBecariosPorEvento") }}',
                    type: 'GET',
                    data: { evento_id: evento_id },
                    success: function(data) {
        ...
        $('#asistenciaForm').on('submit', function(event) {
            ...
            $.ajax({
                url: '{{ route("eventosActualizacion.formActualizacionEventoConRegistro") }}',
                type: 'POST',
                data: formData,
        ...
        $('#becarioForm').on('submit', function(event) {
            ...
            $.ajax({
                url: '{{ route("eventosActualizacion.formRegistroBecarioConfirmacion") }}',
                type: 'POST',
                data: formData,
                success: function(response) {
                    if (response.status === 'success') {
