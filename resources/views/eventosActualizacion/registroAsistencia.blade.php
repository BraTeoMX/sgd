...
<script>
    ...
    $(document).ready(function() {
        ...
        function actualizarConteoTabla(evento_id) {
            if(evento_id) {
                $.ajax({
                    url: '{{ route("eventosActualizacion.obtenerRegistrosPorEvento") }}',
                    type: 'GET',
        ...
        $('#asistenciaForm').on('submit', function(event) {
            ...
            $.ajax({
                url: '{{ route("eventosActualizacion.formRegistroEvento") }}',
                type: 'POST',
                data: formData,
        ...
        $('#becarioForm').on('submit', function(event) {
            ...
            $.ajax({
                url: '{{ route("eventosActualizacion.formRegistroBecario") }}',
                type: 'POST',
                data: formData,
                success: function(response) {
                    // Mostrar el mensaje de SweetAlert con cierre automático
