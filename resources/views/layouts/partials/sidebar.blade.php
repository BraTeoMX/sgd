        ...
        <div class="navbar-vertical-footer-offset">
            ...
            <div class="navbar-vertical-content" style="background-color: #efebe9;">
              ...
              <div class="nav-divider"></div>
                    ...
                    <!-- Pages -->
                @unless(auth()->user()->email == 'simulacro@gmail.com')
                    ...
                    @endif
                @endunless
                @if(auth()->user()->email == 'simulacro@gmail.com')
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('eventos.simulacro') }}" title="Registros simulacro"
                                data-placement="left">
                ...
                @endif
                        ...
                        <li class="navbar-vertical-aside-has-menu">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                ...
                                auth()->user()->hasRole('Administrador Sistema') ||  auth()->user()->hasRole('Jefe Administrativo') || auth()->user()->email=='bteofilo@intimark.com.mx' )
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('eventosActualizacion.inicioEvento') }}" title="Crear Evento"
                                            data-placement="left">
                                            <span class="tio-circle nav-indicator-icon"></span>
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                <li class="nav-item">
                                <a class="nav-link" href="{{ route('eventosActualizacion.registroAsistenciaConRegistro') }}" title="Pre-Registro de Asistencia" data-placement="left">
                                        <i class="tio-circle nav-indicator-icon"></i>
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                <li class="nav-item">
                                <a class="nav-link" href="{{ route('eventosActualizacion.asistenciaConRegistroConfirmacion') }}" title="Confirmar Asistencia" data-placement="left">
                                        <i class="tio-circle nav-indicator-icon"></i>
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('eventosActualizacion.registroAsistencia') }}" title="Asistencia sin Registro" data-placement="left">
                                                <i class="tio-circle nav-indicator-icon"></i>
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('eventosActualizacion.reporteEvento') }}" title="Reporte Eventos"
                                        data-placement="left">
                                        <i class="tio-circle nav-indicator-icon"></i>
                            ...
                            @if (auth()->user()->hasRole('Seguridad e Higiene') || auth()->user()->email=='bteofilo@intimark.com.mx'|| auth()->user()->email=='adejesus@intimark.com.mx'|| auth()->user()->email=='gvm7506@gmail.com' )
                    ...
                    <li class="navbar-vertical-aside-has-menu ">
                       ...
                       <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{!! url('/ausentismo.reporte') !!}" title="Welcome message"
                                        data-placement="left">
                                        <span class="tio-circle nav-indicator-icon"></span>
