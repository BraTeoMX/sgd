                            ...
                            @forelse ($permiso as $per)
                                @if ($per->status == 'APLICADO' )
                                    <tr>
                                        ...
                                        @endif
                                        @if (($per->modo_per == 1 && $per->entrada_permiso!=1) || $per->modo_per == 3)
                                           <td>
                                        ...
                                        @else
                                            @if ($per->modo_per == 1 && $per->entrada_permiso==1)
                                                <tr>
                                                    <td colspan="7" style="color: red; background: black;">El permiso ya no se encuentra activo por registro previo {{ $per->fech_fin_hor}},
                                                        favor de Verificar</td>
                                                </tr>
                                            @endif
                                        @endif
                                        @if (($per->modo_per == 2 && $per->salida_permiso!=1) || $per->modo_per == 3 )
                                            <td>
                                        ...
                                        @else
                                            @if ($per->modo_per == 2 && $per->salida_permiso==1)
                                                <tr>
                                                    <td colspan="7" style="color: red; background: black;">El permiso ya no se encuentra activo por registro previo {{ $per->fech_ini_hor}},
                                                        favor de Verificar</td>
                                                </tr>
                                            @endif
                                        @endif
