...
use App\Http\Controllers\EventoActualizacionController;
...
Route::post('permisos.retardos', 'FormatoPermisosController@retardos'); //verificar los
Route::post('permisos.duplicados', 'FormatoPermisosController@duplicados'); //verificar los permisos duplicados
...
Route::get('ausentismo.reporte', 'AusentismoController@reporte')->name('ausentismo.reporte');
...
Route::post('GenerarReportesExcelPapel', 'ReportesEventosController@exportarExcelPapel')->name('eventos.exportarExcelPapel');
Route::get('GenerarReportesExcelPapel', 'ReportesEventosController@exportarExcelPapel')->name('eventos.exportarExcelPapel');

//Rutas para la vista simulacro
Route::get('simulacro',[SimulacroController::class, 'simulacro'])->name('eventos.simulacro');

// Ruta para procesar el formulario de la vista simulacro
Route::post('registroSimulacro', [SimulacroController::class, 'registroSimulacro'])->name('eventos.registroSimulacro');
Route::get('/eventos/obtener-conteos-ajax', [SimulacroController::class, 'obtenerConteosAjax'])->name('eventos.obtenerConteosAjax');
Route::post('GenerarReportesSimulacro', 'ReportesEventosController@GenerarReporteSimulacro')->name('eventos.GenerarReporteSimulacro');
Route::post('GenerarReportesExcelSimulacro', 'ReportesEventosController@exportarExcelSimulacro')->name('eventos.exportarExcelSimulacro');
Route::get('GenerarReportesExcelSimulacro', 'ReportesEventosController@exportarExcelSimulacro')->name('eventos.exportarExcelSimulacro');


//apartado para la version 2 de generacion de eventos
Route::get('inicioEvento', [EventoActualizacionController::class, 'inicioEvento'])->name('eventosActualizacion.inicioEvento');
Route::post('/registrarEventos', [EventoActualizacionController::class, 'registrarEventos'])->name('eventosActualizacion.registrarEventos');
Route::delete('eventosActualizacion/{evento}', [EventoActualizacionController::class, 'destroy'])->name('eventosActualizacion.destroy');
Route::get('registroAsistencia', [EventoActualizacionController::class, 'registroAsistencia'])->name('eventosActualizacion.registroAsistencia');
Route::post('formRegistroEvento', [EventoActualizacionController::class, 'formRegistroEvento'])->name('eventosActualizacion.formRegistroEvento');
Route::post('formRegistroBecario', [EventoActualizacionController::class, 'formRegistroBecario'])->name('eventosActualizacion.formRegistroBecario');
Route::get('obtenerRegistrosPorEvento', [EventoActualizacionController::class, 'obtenerRegistrosPorEvento'])->name('eventosActualizacion.obtenerRegistrosPorEvento');

Route::get('registroAsistenciaConRegistro', [EventoActualizacionController::class, 'registroAsistenciaConRegistro'])->name('eventosActualizacion.registroAsistenciaConRegistro');
Route::post('formRegistroEventoConRegistro', [EventoActualizacionController::class, 'formRegistroEventoConRegistro'])->name('eventosActualizacion.formRegistroEventoConRegistro');
Route::post('formRegistroBecarioConRegistro', [EventoActualizacionController::class, 'formRegistroBecarioConRegistro'])->name('eventosActualizacion.formRegistroBecarioConRegistro');
Route::get('obtenerRegistrosPorEventoConRegistro', [EventoActualizacionController::class, 'obtenerRegistrosPorEventoConRegistro'])->name('eventosActualizacion.obtenerRegistrosPorEventoConRegistro');

Route::get('asistenciaConRegistroConfirmacion', [EventoActualizacionController::class, 'asistenciaConRegistroConfirmacion'])->name('eventosActualizacion.asistenciaConRegistroConfirmacion');
Route::post('formActualizacionEventoConRegistro', [EventoActualizacionController::class, 'formActualizacionEventoConRegistro'])->name('eventosActualizacion.formActualizacionEventoConRegistro');
Route::post('formRegistroBecarioConfirmacion', [EventoActualizacionController::class, 'formRegistroBecarioConfirmacion'])->name('eventosActualizacion.formRegistroBecarioConfirmacion');
Route::get('obtenerRegistrosPorEventoConRegistroConfirmacion', [EventoActualizacionController::class, 'obtenerRegistrosPorEventoConRegistroConfirmacion'])->name('eventosActualizacion.obtenerRegistrosPorEventoConRegistroConfirmacion');
Route::get('/obtener-becarios', [EventoActualizacionController::class, 'obtenerBecariosPorEvento'])->name('eventosActualizacion.obtenerBecariosPorEvento');
//apartado para reporte
Route::get('reporteEvento', [EventoActualizacionController::class, 'reporteEvento'])->name('eventosActualizacion.reporteEvento');
