        ...
        */
        ...
        if(date("N", strtotime($row['fec_ini']))== 5)
            ...
            if ($row['tipo_per']=='horas'){
                ...
                if($row['tipo_per']=='dias'){
                    $tipo_per = '6';
                }else{
                    if($row['tipo_per']=='empresa'){
                        $tipo_per = '14';
                        $hora_salida='';
                        $hora_final="";
        ...
        return new FormatoPermisos([
            'folio_per' => substr($fecha_ini,2,2).substr($fecha_ini,5,2).$row['cvetra'].'P',
            'tipo_per' => $tipo_per,
            ...
            'fech_ini_per' => $fecha_ini,
            'fech_fin_per' => $fecha_fin,
