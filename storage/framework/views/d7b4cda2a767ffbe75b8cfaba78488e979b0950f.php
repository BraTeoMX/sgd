            ...
            <div class="card">
                <div class="card-header">
                    <div class="col-md-8 col-lg-8 text-rigth">
                        ...
                        <?php echo BootForm::open(['id' => 'form', 'method' => 'POST', 'route' => 'genperabiertos']); ?>

                        <div class="row">
                            <div class="col-lg-4 col-md-4">
                                <?php echo BootForm::date('inicio_fecha', 'Fecha : ', old('inicio_fecha'), ['width' => 'col-lg-3 col-md-3']); ?>
                ...
                <div class="card-body">
                    ...
                    <div id="datatableWithSearchInput" class="table-responsive datatable-custom">
                        <table id="exportOptionsDatatables"
                            ...
                            <tbody>
                                <?php if(isset($perabiertos)): ?>
                                    <?php $__currentLoopData = $perabiertos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reporte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <?php echo e($reporte->folio_per); ?>

                                            </td>
                                            <td>
                                                <?php echo e($reporte->fech_ini_per); ?>
                                            ...
                                            <td>
                                                <?php if($reporte->modo_per === 1): ?>
                                                    Entra tarde
                                                <?php elseif($reporte->modo_per === 2): ?>
                                                    Sale temprano
                                                <?php elseif($reporte->modo_per === 3): ?>
                                                    Sale y regresa
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php echo e($reporte->fech_ini_hor); ?>

                                            </td>
                                            <td>
                                                <?php echo e($reporte->fech_fin_hor); ?>

                                            </td>
                                            <td>
                                                <?php echo e($reporte->estatus_permiso); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/formatopermisos/abiertos.blade.php ENDPATH**/ ?>