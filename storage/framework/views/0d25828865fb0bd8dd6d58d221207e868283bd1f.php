<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-header">
            ...
            <a href="<?php echo e(route('eventos.ListaEventos')); ?>" class="btn btn-primary deleteReg">Regresar</a>
        </div>
        <div class="card-body">
            <h2>Selecciona una opción</h2>
            <form action="<?php echo e(route('eventos.DeleteRegPre')); ?>" method="post">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $registros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo Form::model($registro, ['method' => 'delete', 'route' => ['eventos.BorrarRegistroPre', $registro->id], 'id' => 'eventoEliminarForm']); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/eventos/DeleteRegPre.blade.php ENDPATH**/ ?>