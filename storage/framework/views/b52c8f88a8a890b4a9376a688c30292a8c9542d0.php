...
<script>
    ...
    $(document).ready(function() {
        function actualizarConteoTabla(evento_id) {
            if(evento_id) {
                $.ajax({
                    url: '<?php echo e(route("eventosActualizacion.obtenerRegistrosPorEventoConRegistro")); ?>',
                    type: 'GET',
        ...
        $('#asistenciaForm').on('submit', function(event) {
            ...
            $.ajax({
                url: '<?php echo e(route("eventosActualizacion.formRegistroEventoConRegistro")); ?>',
                type: 'POST',
                data: formData,
        ...
        $('#becarioForm').on('submit', function(event) {
            ...
            $.ajax({
                url: '<?php echo e(route("eventosActualizacion.formRegistroBecarioConRegistro")); ?>',
                type: 'POST',
                data: formData,
                success: function(response) {
                    if(response.status === 'success') {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/eventosActualizacion/registroAsistenciaConRegistro.blade.php ENDPATH**/ ?>