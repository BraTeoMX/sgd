    ...
    <div class="container-scroller login-register login-sidebar" style="background-image:url(<?php echo asset('img/Intimarklogin.jpg'); ?>);">
        <div class="login-box card">
            <div class="card-body mt-4">
                ...
                <?php echo BootForm::open(['route'=>'password.update','id'=>'form','class'=>'form-horizontal']); ?>
...
<?php /**PATH C:\xampp\htdocs\intimark\resources\views/auth/passwords/reset.blade.php ENDPATH**/ ?>