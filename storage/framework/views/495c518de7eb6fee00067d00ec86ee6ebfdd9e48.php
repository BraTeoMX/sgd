    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $datosEmpleado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permiso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <?php echo BootForm::hidden('excepcion', $excepcion);; ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3"  style="display: none" id='id_inicio_per'>
                        <?php echo BootForm::date('inicio_per', 'INICIO DE PERMISO','',['width'=>'col-md-3', 'min'=>$ayer]); ?>

                    </div>
                    <div class="col-lg-3 col-md-3"  style="display: none" id='id_fin_per'>
                        <?php echo BootForm::date('fin_per', 'FIN DE PERMISO','',['width'=>'col-md-3', 'min'=> $ayer]); ?>
                  ...
                  <!--  <div class="col-lg-3 col-md-3">
                       ...
                       <?php echo BootForm::text('no_permisos', 'NO. DE PERMISOS EN EL MES ',$no_permiso, ['width'=>'col-md-3','readonly']);; ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3"  style="display: none" id='id_inicio_diahor'>
                        <?php echo BootForm::date('inicio_diahor', 'DIA DE PERMISO','',['width'=>'col-md-3', 'min'=>$ayer]); ?>

                    </div>
                    <div class="col-lg-3 col-md-3"  style="display: none" id='id_fin_hor'>
                        <?php echo BootForm::time('inicio_hor', 'HORA INICIAL','',['width'=>'col-md-3' ] ); ?>

                    </div>
                    <div class="col-lg-3 col-md-3"  style="display: none" id='id_inicio_hor'>
                        <?php echo BootForm::time('fin_hor', 'HORA FINAL','',['width'=>'col-md-3']); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/formatopermisos/excepcion.blade.php ENDPATH**/ ?>