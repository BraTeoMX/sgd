...
<div class="card">
<!--
    <?php if( Session::get('registrado') ): ?>

        <div class="alert alert-success alert-dismissible fade show" role="alert">
           <strong>Nueva Solicitud</strong> <?php echo e(Session::get('registrado')); ?>
                    ...
                    <table class="table toggle-circle">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $vacaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vac): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                <?php if($vac->Departamento == '29' and  ($vac->status=='APLICADO' or $vac->status=='ACTIVO')): ?>
                                    <?php    
                                        $i++;
                                    ?>
                                <?php endif; ?>
                            ...
                            <?php $__currentLoopData = $vacaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if(auth()->user()->hasRole('Jefe Administrativo')  ): ?>
                                        ...
                                        <?php if($vacacion->Departamento != '29' ): ?>
                                            <tr>
                                        ...
                                        <?php if($vacacion->Departamento == '29' ): ?>
                                            <tr>
                                                ...
                                                <?php if($vacacion->status=='ACTIVO'): ?>
                                                    ...
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                      <td> <?php echo e($i); ?> </td>
                                                      <td> <?php echo e($valor_ausentismo); ?> </td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.eliminar').on('click', function(event) {
                ...
                Swal.fire({
                    title: 'Estas seguro de denegar la solicitud?',
                    text: "",
                    icon: 'warning',
            ...
            $('.denegar').on('click', function(event) {
              //  alert('Solicitud Denegada por Porcentaje de ausentismo en el modulo');
                Swal.fire({
                    title: 'OOPS',
                    text: "Solicitud Denegada por Porcentaje de ausentismo en el modulo",
                    icon: 'warning',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sia\resources\views/vacaciones/index.blade.php ENDPATH**/ ?>