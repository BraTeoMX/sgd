        ...
        <div class="card">
            ...
            <table id="exportOptionsDatatables" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
                ...
                <tr>
                    ...
                    <?php if($vacacion->eventualidades == 1): ?>
                        <?php
                    ...
                    <?php else: ?>
                        ...
                        ?>
                    <?php endif; ?>
                    <td><?php echo e($des_eventualidad); ?></td>
                    <?php $__currentLoopData = $puestos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $puesto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($puesto->jefe_directo == $vacacion->jefe_directo): ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/consultaexcepciones/index.blade.php ENDPATH**/ ?>