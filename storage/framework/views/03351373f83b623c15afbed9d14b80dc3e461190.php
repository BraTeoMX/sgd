...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <?php echo Form::open(['route' => 'formatopermisos.store', 'method' => 'POST', 'files' => true]); ?>

            <?php $__empty_1 = true; $__currentLoopData = $datosEmpleado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permiso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php echo BootForm::hidden('id_emp', $permiso->id_empleado); ?>

                <?php echo BootForm::hidden('tag_emp', $permiso->No_TAG); ?>

                <?php echo BootForm::hidden('no_aux', auth()->user()->no_empleado); ?>

                <?php echo BootForm::hidden('id_dep', $permiso->Departamento); ?>

                <?php echo BootForm::hidden('no_permisos', $no_permiso); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <?php echo BootForm::text('no_empleado', 'No. EMPLEADO ', $permiso->No_Empleado, ['width' => 'col-md-3', 'readonly']); ?>

                    </div>
                    <div class="col-lg-3 col-md-3">
                        <?php echo BootForm::text('nom_emp', 'NOMBRE ', $permiso->Nom_Emp, ['width' => 'col-md-3', 'readonly']); ?>

                    </div>
                    <div class="col-lg-3 col-md-3">
                        <?php echo BootForm::text('ap_pat', 'APELLIDO PATERNO ', $permiso->Ap_Pat, ['width' => 'col-md-3', 'readonly']); ?>

                    </div>
                    <div class="col-lg-3 col-md-3">
                        <?php echo BootForm::text('ap_mat', 'APELLIDO MATERNO ', $permiso->Ap_Mat, ['width' => 'col-md-3', 'readonly']); ?>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3">
                        <?php echo BootForm::text('modulo_emp', 'MODULO ', $permiso->Modulo, ['width' => 'col-md-3', 'readonly']); ?>

                    </div>
                    <div class="col-lg-3 col-md-3">
                        <!--   <?php echo BootForm::text('turno', 'TURNO ', $permiso->Id_Turno, ['width' => 'col-md-3', 'readonly']); ?>-->
                        <?php if($permiso->Frec_Pago == '00001'): ?>
                            <?php echo BootForm::text('frec_pago', 'PAGO', 'SEMANAL', ['width' => 'col-md-3', 'readonly']); ?>

                        <?php else: ?>
                            <?php if($permiso->Frec_Pago == '00002'): ?>
                    ...
                    <?php $__currentLoopData = $puestos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $puesto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($puesto->id_puesto == $permiso->Puesto): ?>
                            <div class="col-lg-3 col-md-3">
                    ...
                    <?php $__currentLoopData = $departamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($dep->id_Departamento == $permiso->Departamento): ?>
                            <div class="col-lg-3 col-md-3">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <select class='form-control' aria-label="Default select example" name="permiso" id="permiso">
                            ...
                            <option value=1><?php echo e('PERMISO CON GOCE DE SUELDO x DIA'); ?></option>
                            <option value=2><?php echo e('PERMISO SIN GOCE DE SUELDO x DIA'); ?></option>
                            <option value=3><?php echo e('PERMISO CON GOCE DE SUELDO x HORAS'); ?></option>
                            <option value=4><?php echo e('PERMISO SIN GOCE DE SUELDO x HORAS'); ?></option>
                        </select>
                    </div>
                    <div class="col-lg-6 col-md-6" style="display: none" id='id_motivo' name='id_motivo'>
                        <?php echo BootForm::select('motivo', 'MOTIVO DE PERMISO: ', [], old('id_permiso')); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3" style="display: none" id='id_inicio_per'>
                        <?php echo BootForm::date('inicio_per', 'INICIO DE PERMISO', '', ['width' => 'col-md-3', 'min' => $hoy]); ?>

                    </div>
                    <div class="col-lg-3 col-md-3" style="display: none" id='id_fin_per'>
                        <?php echo BootForm::date('fin_per', 'FIN DE PERMISO', '', ['width' => 'col-md-3', 'min' => $hoy]); ?>

                    </div>
                    <div class="col-lg-3 col-md-3" style="display: none" id='id_dias'>
                        <?php echo BootForm::text('dias', 'NUMERO DE DIAS SOLICITADOS', '', ['width' => 'col-md-3', 'readonly']); ?>

                    </div>
                    <!--  <div class="col-lg-3 col-md-3">

                                               <?php echo BootForm::text('no_permisos', 'NO. DE PERMISOS EN EL MES ', $no_permiso, [
                                                   'width' => 'col-md-3',
                                                   'readonly',
                                               ]); ?>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6" style="display: none" id='id_modo_permiso'>
                        ...
                        <select class='form-control' aria-label="Default select example" name="modo_permiso"
                            id="modo_permiso">
                            <option value=0><?php echo e('--SELECCIONE--'); ?></option>
                            <option value=1><?php echo e('SOLO ENTRADA'); ?></option>
                            <option value=2><?php echo e('SOLO SALIDA'); ?></option>
                            <option value=3><?php echo e('SALIDA Y ENTRADA'); ?></option>
                        </select>
                    </div>
                    <div class="col-lg-6 col-md-6" style="display: none" id='id_hora_comida'>
                        ...
                        <select class='form-control' aria-label="Default select example" name="hora_comida"
                            id="hora_comida">
                            <option value=0><?php echo e('--SELECCIONE--'); ?></option>
                            <option value=1><?php echo e('MEDIA HORA'); ?></option>
                            <option value=2><?php echo e('UNA HORA'); ?></option>
                            <option value=3><?php echo e('NO APLICA'); ?></option>
                        </select>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3" style="display: none" id='id_inicio_diahor'>
                        <?php echo BootForm::date('inicio_diahor', 'DIA DE PERMISO', '', ['width' => 'col-md-3', 'min' => $hoy]); ?>

                    </div>
                    <div class="col-lg-3 col-md-3" style="display: none" id='id_fin_hor'>
                        <?php echo BootForm::time('inicio_hor', 'HORA ', '', ['width' => 'col-md-3']); ?>

                    </div>
                    <div class="col-lg-3 col-md-3" style="display: none" id='id_inicio_hor'>
                        <?php echo BootForm::time('fin_hor', 'HORA ', '', ['width' => 'col-md-3']); ?>

                    </div>
                    <div class="col-lg-3 col-md-3" style="display: none" id='id_horas'>
                        <?php echo BootForm::text('horas', 'MINUTOS SOLICITADOS', '', ['width' => 'col-md-3', 'readonly']); ?>
                ...
                <?php if(auth()->user()->hasRole('Servicio Medico')): ?>
                    <div class="row">
                        <div class="col-lg-12 col-md-12" style="display: none" id='id_autoriza' name='id_autoriza'>
                            <?php echo BootForm::textarea('obs', 'OBSERVACIONES', '', ['rows' => '2', 'style' => 'rezise:true']); ?>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6" style="display: none" id='id_autoriza' name='id_autoriza'>
                        <?php echo BootForm::select('autorizar', 'PERSONA RESPONSABLE DE AUTORIZAR: ', [], old('id_permiso')); ?>
...
<?php $__env->startSection('scriptBFile'); ?>
    ...
    <script>
        ...
        $('#id_inicio_diahor').change(function() {
            if($('#modo_permiso').val() == 1){
                $.ajax({
                        url: 'permisos.duplicados',
                        method: 'POST',
                        data: {
                            empleado: $('#no_empleado').val(),
                            dia:$('#inicio_diahor').val(),
                        ...
                        if (res > 0) {
                            Swal.fire({
                                title: '',
                                text: "El Colaborador ya ha solicitado permiso de entrada para el dia de hoy, verificar con el área de Nóminas ",
                                imageUrl: 'img/logo.png',
                                imageWidth: 300,
                                imageHeight: 150,
                                imageAlt: 'Custom image',
        ...
        $('#permiso').change(function() {
            ...
            $.get('<?php echo e(url('/')); ?>/consultasajax/getmotivopermisos/' + tipo, function(data) {
                ...
                $.ajax({
                    ...
                    if (res > 0) {
                        if (($('#frec_pago').val() == 'SEMANAL' && res >= 2) || ($('#frec_pago').val() ==
                            ...
                            $.get('<?php echo e(url('/')); ?>/consultasajax/getautorizar/' + tipo, function(
                                data) {
                                $('#autorizar').empty();
                        ...
                        var tipo = $('#motivo').val() + "|" + $('#no_empleado').val() + "|" + $(
                            'input[name=no_aux]').val();
                        $.get('<?php echo e(url('/')); ?>/consultasajax/getautorizar/' + tipo, function(data) {
                            $('#autorizar').empty();
                            //   $('#autorizar').append('<option value="0">'+'--SELECCIONE--'+'</option>');
                            $.each(data, function(fetch, regenciesObj) {
                                $('#autorizar').append('<option value="' + regenciesObj
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/formatopermisos/index.blade.php ENDPATH**/ ?>