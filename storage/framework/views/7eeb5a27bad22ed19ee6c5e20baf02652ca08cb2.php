        ...
        <li class="nav-item"> 
          ...
          <div class="hs-unfold">
            ...
            <a class="js-hs-unfold-invoker navbar-dropdown-account-wrapper" href="javascript:;"
               ...
               <div>
               <span class="card-text"><font color="white"><?php echo e(Auth::user()->name); ?></font></span>

              </div>
              <div class="avatar avatar-sm avatar-circle"> 

                <img class="avatar-img" src="<?php echo asset('/materialfront/assets/img/160x160/img1.jpg'); ?>" alt="Image Description">
...
<?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/layouts/partials/header.blade.php ENDPATH**/ ?>