            ...
            <table class="table" id="products_table">
                ...
                <?php $__currentLoopData = $orderProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $orderProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <?php echo BootForm::text("orderProducts[".$index."][kilometraje_recoleccion]", false, old("orderProducts[".$index."][kilometraje_recoleccion]"), ["wire:model"=>"orderProducts.".$index.".kilometraje_recoleccion", "required"=>true]);; ?>
                        ...
                        <td>
                            <?php echo BootForm::select("orderProducts[".$index."][cliente_id]", false, $allClientes, old("orderProducts[".$index."][cliente_id]"), ["wire:model"=>"orderProducts.".$index.".cliente_id", "required"=>true]);; ?>
...
<?php /**PATH C:\xampp\htdocs\sgd\resources\views\livewire\logistica-destino-materiales.blade.php ENDPATH**/ ?>