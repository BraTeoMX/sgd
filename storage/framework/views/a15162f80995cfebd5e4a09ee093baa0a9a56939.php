                    ...
                    <?php if($responsables->isNotEmpty()): ?>
                        <table class="table toggle-circle tabla-foot" data-page-size="25">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo e($responsable->guard_name); ?>

                                    </td>
                                    <?php $__currentLoopData = $incidencias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $incidencia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <td>
                                    <?php echo Form::checkbox($responsable->guard_name.'['.$incidencia->name.']',$incidencia->name,old('check','') , ['id' => 'check'.$responsable->id.'-'.$incidencia->id, 'class' => 'i-checks','width'=> 'col-lg-2']);; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\intimark\resources\views/autorizacion/index.blade.php ENDPATH**/ ?>