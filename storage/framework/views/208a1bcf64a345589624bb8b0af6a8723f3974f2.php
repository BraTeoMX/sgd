            ...
            <div class="card-body">
                ...
                <div class="form-group">   
                    <div class="col-8 input-group">
                        ...
                        <input type="search" class="form-control col-8" id="puestos" name="puestos">
                        <span class="col-2">
                ...
                <div class="row"> 
                    <div class="col-12">
                        ...
                        <tr>
                            <td>
                                <a href="<?php echo e(route('puestos.edit', $puesto->id_Puesto)); ?>">
                            ...
                            <td class="float-center">
                                <?php echo Form::model($puesto, ['method' => 'delete', 'route' => ['puestos.destroy',$puesto->id_Puesto] ]); ?>
...
<script>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\intimark\resources\views/puestos/index.blade.php ENDPATH**/ ?>