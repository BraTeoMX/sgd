            ...
            <div class="row">
                ...
                <?php echo BootForm::open(['id' => 'form', 'class' => '','method'=>'POST','route' => 'acceso.index']); ?>
                    ...
                    <?php if($permisos->isNotEmpty()): ?>
                        ...
                        <?php echo BootForm::hidden('rol',$rol[0]->id); ?>

                            <thead>
                                <tr>
                                    <th>Permiso</th>                                   
                                    <th><?php echo e($rol[0]->name); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo Form::checkbox($rol[0]->name.'['.$permiso->name.']',$permiso->name,
                ...
                <div class="row">
                    ...
                    <a href="<?php echo url('/acceso'); ?>" class="text text-danger btn-link float-middle ml-4">Cancelar</a>
                    </div>
                </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\accesos\index_nuevo.blade.php ENDPATH**/ ?>