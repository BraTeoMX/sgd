                                        ...
                                        <?php $__currentLoopData = $permisos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permiso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <td><?php echo e($permiso->fech_fin_hor); ?></td>
                                                <?php endif; ?>
                                                <?php if($permiso->hora_comida == 1): ?>
                                                    <td><?php echo e('MEDIA HORA'); ?></td>
                                                <?php else: ?>
                                                    <?php if($permiso->hora_comida == 2): ?>
                                                        <td><?php echo e('UNA HORA'); ?></td>
                                                    <?php else: ?>
                                                        <?php if($permiso->hora_comida == 3): ?>
                                                            <td><?php echo e('NO APLICA'); ?></td>
                                                        <?php else: ?>
                                                            <td></td>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                ...
                                                <td><?php echo e($minutos); ?></td>
                                                <td><?php echo e($permiso->permiso); ?></td>
                                                <?php if($permiso->modo_per == 1): ?>
                                                    <td><?php echo e('ENTRADA'); ?></td>
                                                <?php else: ?>
                                                    <?php if($permiso->modo_per == 2): ?>
                                                        <td><?php echo e('SALIDA'); ?></td>
                                                    <?php else: ?>
                                                        <?php if($permiso->modo_per == 3): ?>
                                                ...
                                                <?php $__currentLoopData = $jefe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $autoriza): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($permiso->jefe_directo == 0): ?>
                                                        <td></td>
                                                    <?php else: ?>
                                                        <?php if($autoriza->id_puesto == $permiso->jefe_directo): ?>
                                                            <?php if($autoriza->Puesto == 'ANALISTA PRODUCCION'): ?>
                                                                <td>TEAM LEADER</td>
                                                            <?php else: ?>
                                                                <?php if($autoriza->Puesto == 'ANALISTA ORDENES MANUFACT II'): ?>
                                                                    <td>GERENTE MANUFACTURA</td>
                                                                <?php else: ?>
                                                                    <?php if($autoriza->Puesto == 'ANALISTA CALIDAD'): ?>
                                                                        <td> GERENTE CONTROL DE CALIDAD</td>
                                                                    <?php else: ?>
                                                                        <?php if($autoriza->Puesto == 'ANALISTA CORTE'): ?>
                                                                        <td>GERENTE CORTE</td>
                                                                        <?php else: ?>
                                                                            <td><?php echo e($autoriza->Puesto); ?></td>
                                                                        <?php endif; ?>
                                                                    <?php endif; ?>
                                                                <?php endif; ?>
                                                            <?php endif; ?>
                                                ...
                                                <?php if(auth()->user()->hasRole('Administrador Sistema')): ?>
                                                    <td class="float-center">
                                                        <a class="btn btn-light float-right"
                                                            href="<?php echo e(route('consultapermisos.ticket', $permiso->folio_per)); ?>">Formato</a>
                                                    </td>
                                                <?php endif; ?>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/consultaPermisos/index.blade.php ENDPATH**/ ?>