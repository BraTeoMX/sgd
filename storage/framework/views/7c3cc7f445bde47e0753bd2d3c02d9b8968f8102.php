            ...
            <?php $__empty_1 = true; $__currentLoopData = $datosEmpleado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="row">     
                    <div class="col-lg-3 col-md-3"  style="display: none" id='id_inicio_vac'>
                        <?php echo BootForm::date('inicio_vac', 'INICIO DE VACACIONES'); ?>

                    </div>
                    <div class="col-lg-3 col-md-3"  style="display: none" id='id_fin_vac'>
                        <?php echo BootForm::date('fin_vac', 'FIN DE VACACIONES'); ?>                
                    </div>
                    <div class="col-lg-3 col-md-3" >
...
<script>
    $(document).ready(function() {
        if($('#dias_disponibles').val()<=0){
           // alert("Lo sentimos, no tiene dias disponibles para vacaciones");
           Swal.fire({
                title: 'OOPS',
                text: "Lo sentimos, no tiene dias disponibles para vacaciones",
                icon: 'warning',
        ...
        $('#eventualidad').change(function () {
            if($('#eventualidad').val() == 1){
                ...
                if($('#eventualidades').val().substr(0,1) == $('#eventualidades').val().substr(2,1) ){
                  //  alert("Se han cubierto el numero de eventualidades permitidas, favor de verificar");
                   // window.location.href = '/home';
                    Swal.fire({
                        title: 'OOPS',
                        text: "Se han cubierto el número de eventualidades permitidas, favor de verificar",
                        icon: 'warning',
                        showCancelButton: false,
                        confirmButtonColor: '#3085d6',
                        cancelButtonColor: '#d33',
                ...
                if($('#periodos').val().substr(0,1) == $('#periodos').val().substr(2,1) ){
                  //  alert("Se han cubierto el numero de periodos permitidos, favor de verificar");
                   // window.location.href = '/home';
                    Swal.fire({
                        title: 'OOPS',
                        text: "Se han cubierto el numero de periodos permitidos, favor de verificar",
                        icon: 'warning',
                        showCancelButton: false,
                        confirmButtonColor: '#3085d6',
                        cancelButtonColor: '#d33',
           ...
           if($('#eventualidad').val() == 1){
                ...
                if( validadorFecha==1 ) 
                {
                   // alert('Las fechas no pueden ser menor de la fecha actual');
                    Swal.fire({
                        title: 'OOPS',
                        text: "Las fechas no pueden ser menor de la fecha actual",
                        icon: 'warning',
                        showCancelButton: false,
                        confirmButtonColor: '#3085d6',
                        cancelButtonColor: '#d33',
                       ...
                       // alert('Las fechas no pueden ser menor de la fecha actual');
                        ...
                        if( validadorFecha2==1){
                          //  alert('Las vacaciones deben ser ingresadas mínimo con una semana de anticipación');
                            Swal.fire({
                                    title: 'OOPS',
                                    text: "Las vacaciones deben ser ingresadas mínimo con una semana de anticipación",
                                    icon: 'warning',
                                    showCancelButton: false,
                                    confirmButtonColor: '#3085d6',
                                    cancelButtonColor: '#d33',
               ...
               if( validadorFecha3==1 ) 
                {
                    ...
                    if (disponibles==1)
                    {
                        ...
                        Swal.fire({
                            title: 'OOPS',
                            text: "Solo puede tomar 1 dia de vacaciones como remanente",
                            icon: 'warning',
                            showCancelButton: false,
                            confirmButtonColor: '#3085d6',
                            cancelButtonColor: '#d33',
                        ...
                        if (solicitados == 1){
                          //  alert( "El periodo de vacaciones debe de ser de 2 dias o mayor" );
                            Swal.fire({
                                title: 'OOPS',
                                text: "El periodo de vacaciones debe de ser de 2 dias o mayor",
                                icon: 'warning',
                                showCancelButton: false,
                                confirmButtonColor: '#3085d6',
                                cancelButtonColor: '#d33',
                            ...
                            if (solicitados > disponibles){
                                if(disponibles != 0){
                                    ...
                                    Swal.fire({
                                        title: 'OOPS',
                                        text: "!! Los dias Solicitados: "+solicitados+" excede el número de dias disponibles: "+disponibles+", favor de verificar.",
                                        icon: 'warning',
                                        showCancelButton: false,
                                        confirmButtonColor: '#3085d6',
                                        cancelButtonColor: '#d33',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sia\resources\views/vacaciones/solicitud_vac.blade.php ENDPATH**/ ?>