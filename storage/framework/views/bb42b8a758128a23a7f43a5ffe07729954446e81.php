    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $datosEmpleado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <?php echo BootForm::hidden('id_dep', $vacacion->Departamento);; ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <?php echo BootForm::text('turno', 'TURNO ', $vacacion->Id_Turno, ['width'=>'col-md-3','readonly']);; ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2">
                        <?php echo BootForm::text('saldo_dias', 'SALDO DE DIAS', number_format($total_vac,0), ['width'=>'col-md-3','readonly']);; ?>

                    </div>
                    <div class="col-lg-2 col-md-2">
                        <?php echo BootForm::text('dias_reservados', 'DIAS RESERVADOS', number_format(0,0), ['width'=>'col-md-3','readonly']);; ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3">
                        ...
                        <?php echo BootForm::text('eventualidades', 'EVENTUALIDADES',$eventualidad.'/'. $valor_event, ['width'=>'col-md-3','readonly']);; ?>
                    ...
                    <div class="col-lg-3 col-md-3">
                         <?php $__currentLoopData = $parametros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parametro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php echo BootForm::text('periodos', 'PERIODOS',$periodo.'/'.$valor_periodo, ['width'=>'col-md-3','readonly']);; ?>
                ...
                <?php if($vacacion->Modulo != '' || auth()->user()->hasRole('Coordinador/Analista')): ?>
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                                    ...
                                    <?php if($i->id_puesto_solicitante != $i->id_jefe ): ?>
                                        ...
                                        <?php else: ?>
                                            <?php if(auth()->user()->hasRole('Seguridad e Higiene')): ?>
                                                ...
                                                <?php if(strtoupper(auth()->user()->name) == $vacacion->Nom_Emp.' '.$vacacion->Ap_Pat.' '.$vacacion->Ap_Mat): ?>
                                                  <option value=<?php echo e($i->No_Empleado); ?>><?php echo e($i->Nom_Emp.' '.$i->Ap_Pat.' '.$i->Ap_Mat); ?></option>
                                                <?php else: ?>


                                                        <option value=<?php echo e(auth()->user()->no_empleado); ?>><?php echo e(strtoupper(auth()->user()->name)); ?></option>
...
//alert(res);
                    ...
                    if (disponibles==1)
                    {
                        ...
                        if (solicitados <= 2 && disponibles >=3){
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/vacaciones/solicitud_vac.blade.php ENDPATH**/ ?>