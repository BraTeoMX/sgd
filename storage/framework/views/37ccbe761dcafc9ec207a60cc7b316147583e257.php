    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $datosEmpleado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <?php echo BootForm::hidden('edo_neg', $vacacion->cveci2);; ?>
                ...
                <div class="row">
                <div class="col-lg-3 col-md-3">
                        <?php echo BootForm::text('fecha_in', 'FECHA DE INGRESO ', $vacacion->Fecha_In, ['width'=>'col-md-3','readonly']);; ?>
                ...
                <div class="row" >
                    ...
                    PERIODO <?php echo e($periodos1." / ".$periodos2); ?>

                    </div>
                    <div class="col-lg-6 col-md-6" style="background-color: #765341; color: #fff"">
                    PERIODO <?php echo e($periodos3." / ".$periodos4); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2">
                        <?php echo BootForm::text('saldo_anterior', 'SALDO DISPONIBLE ', number_format($vigencia->saldo_anterior,0), ['width'=>'col-md-3','readonly']);; ?>
                    ...
                    <div class="col-lg-1 col-md-1">
                        ...
                        <?php echo BootForm::text('event_anterior', 'EVENT. ',$vigencia->event_anterior.'/'. $valor_event, ['width'=>'col-md-3','readonly']);; ?>
                    ...
                    <div class="col-lg-1 col-md-1">
                         <?php $__currentLoopData = $parametros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parametro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php echo BootForm::text('periodo_anterior', 'PERIODO ', $vigencia->periodo_anterior.'/'.$valor_periodo, ['width'=>'col-md-3','readonly']);; ?>

                    </div>
                    <div class="col-lg-2 col-md-2">
                        <?php echo BootForm::text('vigencia_anterior', 'VIGENCIA ', $vigencia->vigencia_anterior, ['width'=>'col-md-3','readonly']);; ?>

                    </div>
                    <div class="col-lg-2 col-md-2">
                        <?php echo BootForm::text('saldo_nuevo', 'SALDO DISPONIBLE ', number_format($vigencia->saldo_nuevo,0), ['width'=>'col-md-3','readonly']);; ?>
                    ...
                    <div class="col-lg-1 col-md-1">
                        ...
                        <?php echo BootForm::text('event_nuevo', 'EVENT. ',$vigencia->event_nuevo.'/'. $valor_event, ['width'=>'col-md-3','readonly']);; ?>
                    ...
                    <div class="col-lg-1 col-md-1">
                         <?php $__currentLoopData = $parametros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parametro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php echo BootForm::text('periodo_nuevo', 'PERIODO ', $vigencia->periodo_nuevo.'/'.$valor_periodo, ['width'=>'col-md-3','readonly']);; ?>

                    </div>
                    <div class="col-lg-2 col-md-2">
                        <?php echo BootForm::text('vigencia_nuevo', 'VIGENCIA ', $vigencia->vigencia_nuevo, ['width'=>'col-md-3','readonly']);; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/vacaciones/solicitud_vac2023.blade.php ENDPATH**/ ?>