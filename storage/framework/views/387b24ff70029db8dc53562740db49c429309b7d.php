            ...
            <table id="exportOptionsDatatables" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php if($vacacion->status=='CANCELADO'): ?>
                        <td><?php echo e($vacacion->updated_at); ?></td>
                        <?php else: ?>
                        <td><?php echo e($vacacion->fecha_solicitud); ?></td>
                        <?php endif; ?>
                        <td><?php echo e($vacacion->fech_ini_vac); ?></td>
                        <td><?php echo e($vacacion->fech_fin_vac); ?></td>
                        <td><?php echo e($vacacion->Id_Planta); ?></td>
                        <td><?php echo e($vacacion->Id_Turno); ?></td>
                        ...
                        <?php $__currentLoopData = $jefe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $autoriza): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($autoriza->id_puesto == $vacacion->jefe_directo): ?>
                        ...
                        <td><?php echo e($vacacion->autorizado_por); ?></td>
                        <?php if(auth()->user()->hasRole("Administrador Sistema")): ?>
                        <td class="float-center">
                            <a class="btn btn-light float-right" href="<?php echo e(route('consultavacaciones.ticket', $vacacion->folio_vac)); ?>">Formato</a>
                        </td>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/consultavacaciones/index.blade.php ENDPATH**/ ?>