...
<body onload="onSign();">
  ...
  <table border="1" cellpadding="2"  width="500"  style="margin: 100 auto;">
    <tr  >
      <td height="100" width="500"  >
		...
		<?php echo BootForm::text('folio', $folio);; ?>
 ...
 <!--  <canvas name="SigImg" id="SigImg" width="500" height="100"></canvas>
   ...
   <!-- <form action="#" name=FORM1 style="margin: auto; width: 220px;" ENCTYPE='multipart/form-data'>-->
    ...
    <!--    <input id="button2" name="DoneBtn" type="button" value="Aceptar" onclick="javascript:onDone()"/>&nbsp;&nbsp;&nbsp;&nbsp; href="<?php echo route('estatuspermisos.index'); ?> -->
        <td><a class="btn btn-info"  name="DoneBtn" id='button2'  onclick="javascript:onDone()" href="<?php echo route('estatuspermisos.index',$folio); ?> " >Aceptar</a></td>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/formatopermisos/firmas2.blade.php ENDPATH**/ ?>