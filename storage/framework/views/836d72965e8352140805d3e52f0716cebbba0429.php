            ...
            <?php $__empty_1 = true; $__currentLoopData = $datosEmpleado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3"  style="display: none" id='id_inicio_vac'>
                        <?php echo BootForm::date('inicio_vac', 'INICIO DE VACACIONES','',['width'=>'col-md-3']); ?>

                    </div>
                    <div class="col-lg-3 col-md-3"  style="display: none" id='id_fin_vac'>
                        <?php echo BootForm::date('fin_vac', 'FIN DE VACACIONES','',['width'=>'col-md-3']); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/vacaciones/solicitud_vac2.blade.php ENDPATH**/ ?>