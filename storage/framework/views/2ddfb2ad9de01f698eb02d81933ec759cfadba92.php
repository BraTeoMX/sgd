    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                    <h1>Asistencia: <?php echo e($contador); ?></h1>
            </div>
            <div class="card-body">
                ...
                <div class="container">
                    ...
                    <form method="POST" action="<?php echo e(route('eventos.RegistroAsistencias')); ?>">
                        <?php echo csrf_field(); ?>
...
<script>
    ...
    function enviarDatosAlControlador(data) {
        const url = '<?php echo e(route('eventos.AsistenciaBecarios')); ?>'; // Ruta al controlador Laravel
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      tipoEventoSelect.addEventListener("change", function () {
          ...
          if (selectedValue !== "default") {
              ...
              tituloEvento.textContent = "Asistencia: <?php echo e($contador); ?>"; // Vuelve al título original
          }
      });
  });
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/eventos/RegistroAsistencias.blade.php ENDPATH**/ ?>