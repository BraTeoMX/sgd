...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('eventosActualizacion.reporteEvento')); ?>" method="GET" id="filterForm">
                    <div class="row">
                        <!-- Select para eventos -->
                        <div class="form-group col-md-6">
                            ...
                            <select id="evento_id" name="evento_id" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $eventos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($evento->id); ?>" <?php echo e($evento->id == $eventoId ? 'selected' : ''); ?>>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="planta_filter" name="planta_filter" class="form-control">
                                ...
                                <option value="Intimark1" <?php echo e(request('planta_filter') == 'Intimark1' ? 'selected' : ''); ?>>Planta 1</option>
                                <option value="Intimark2" <?php echo e(request('planta_filter') == 'Intimark2' ? 'selected' : ''); ?>>Planta 2</option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="tabla-reporte" class="table table-bordered">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $registros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($dato->no_empleado); ?></td>
                                    <td><?php echo e($dato->nombre_empleado); ?></td>
                                    <td><?php echo e($dato->puesto); ?></td>
                                    <td><?php echo e($dato->departamento); ?></td>
                                    <td><?php echo e($dato->planta); ?></td>
                                    <?php if($mostrarAsistencia): ?>
                                        <td><?php echo e($dato->asistencia); ?></td>
                                    <?php endif; ?>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                        <tfoot>
                            <tr>
                                <th colspan="<?php echo e($mostrarAsistencia ? 5 : 4); ?>">Total Registros</th>
                                <th>
                                    <?php echo e($totalRegistros); ?>
            ...
            buttons: [
                {
                    ...
                    customize: function(xlsx) {
                        ...
                        const totalRegistros = "<?php echo e($totalRegistros); ?>";
                        const confirmados = "<?php echo e($confirmados); ?>";
                        const mostrarAsistencia = "<?php echo e($mostrarAsistencia ? 'true' : 'false'); ?>";
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/eventosActualizacion/reporteEvento.blade.php ENDPATH**/ ?>