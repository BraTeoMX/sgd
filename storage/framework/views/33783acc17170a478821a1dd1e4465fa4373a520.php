<aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered">
            ...
            <li class="nav-item">
              ...
              <li class="navbar-vertical-aside-has-menu " >
                ...
                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                 ...
                 <li class="nav-item">
                   <a class="nav-link" href="<?php echo url('/calendario'); ?>" title="Welcome message" data-placement="left">
                     <span class="tio-circle nav-indicator-icon"></span>
         ...
         <!--<li class="nav-item">
            ...
            <li class="navbar-vertical-aside-has-menu " >
              ...
              <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo url('/consultaexcepciones'); ?>" title="Welcome message" data-placement="left">
                      <span class="tio-circle nav-indicator-icon"></span>
            ...
            <?php endif; ?>
              <?php if(auth()->user()->hasPermissionTo("vacaciones.solicitarvacaciones") && !auth()->user()->hasPermissionTo("usuario.index")): ?>
                  ...
                  <li class="nav-item">
                    ...
                    <?php if(auth()->user()->hasRole("Team Leader") ): ?>)
                    <li class="nav-item">
                      <a class="nav-link" href="<?php echo url('/estatusvacaciones'); ?>" title="Welcome message" data-placement="left">
                        <span class="tio-circle nav-indicator-icon"></span>
  ...
  <?php /**PATH C:\xampp\htdocs\intimark\resources\views/layouts/partials/sidebar.blade.php ENDPATH**/ ?>