...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $vacaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="row">    
            ...
            <div class="col-md-4">                                
                <?php echo BootForm::text('dias_disponibles', 'Nombre: *', $vacacion->Nom_Emp.' '.$vacacion->Ap_Pat.' '.$vacacion->Ap_Mat, ['width'=>'col-md-3','readonly']);; ?>
    ...
    <div class="raw">
        <div class="col center">
            <a class="btn btn-success" href="<?php echo route('liberarPermiso',$vacacion->folio_vac); ?>">LIBERAR VACACIONES</a>
        </div>        
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\intimark\resources\views/vacaciones/liberar.blade.php ENDPATH**/ ?>