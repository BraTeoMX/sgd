                            ...
                            <?php $__currentLoopData = $vacaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                       <td class="float-center">
                                                                <?php echo Form::model($vacaciones, ['method' => 'update', 'route' => ['vacaciones.update2',$vacacion->folio_vac] ]); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/vacaciones/cancelacion.blade.php ENDPATH**/ ?>