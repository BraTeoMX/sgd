            ...
            <div class="card">
                <div class="card-header">
                    <div class="col-md-8 col-lg-8 text-rigth">
                        ...
                        <?php echo BootForm::open(['id' => 'form', 'method' => 'GET', 'route' => 'busquedaincapacidades']); ?>
                            ...
                            <tbody>
                                <?php if(isset($reportes)): ?>
                                    <?php $__currentLoopData = $reportes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reporte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <?php echo e($reporte->status); ?>

                                            </td>
                                            <td>
                                                <?php echo e($reporte->folio_incapacidad); ?>

                                            </td>
                                            <td>
                                                <?php echo e($reporte->fecha_inicio); ?>

                                            </td>
                                            <td>
                                                <?php echo e($reporte->dias); ?>

                                            </td>
                                            <td>
                                                <?php echo e($reporte->fecha_fin); ?>

                                            </td>
                                            <td>
                                                <?php echo e($reporte->fk_empleado); ?>
                                            ...
                                            <?php if($reporte->tipo_incapacidad === '01'): ?>
                                                <td>
                                                    INICIAL
                                                </td>
                                            <?php elseif($reporte->tipo_incapacidad === '02'): ?>
                                                <td>
                                                    SUBSECUENTE
                                                </td>
                                            <?php elseif($reporte->tipo_incapacidad === '03'): ?>
                                                <td>
                                                    RECAIDA
                                                </td>
                                            <?php else: ?>
                                            ...
                                            <?php if(auth()->user()->hasRole('Servicio Medico')): ?>
                                                <td>
                                                    <?php echo e(Crypt::decrypt($reporte->comentario)); ?>

                                                </td>
                                                <td>
                                                    <?php echo e($reporte->formato_incapacidad); ?>

                                                    <br>
                                                    <!--<a href="Documentos/Sem 08_Victor Manuel Cruz Mendoza.pdf" target="_blank">Ver archivo</a>-->
                                                    <a href="<?php echo e(str_replace('E:\xampp1\htdocs\intimark_sgd\public\Documentos', 'Documentos', $reporte->ruta_incapacidad)); ?>"
                                                        target="_blank">Ver documento</a>
                                                </td>
                                                <td>
                                                    <?php echo e($reporte->formato_st9); ?>

                                                    <br>
                                                    <!--<a href="Documentos/Sem 08_Victor Manuel Cruz Mendoza.pdf" target="_blank">Ver archivo</a>-->
                                                    <a href="<?php echo e(str_replace('E:\xampp1\htdocs\intimark_sgd\public\Documentos', 'Documentos', $reporte->ruta_st9)); ?>"
                                                        target="_blank">Ver documento</a>
                                                </td>
                                                <td>
                                                    <?php echo e($reporte->formato_st7); ?>

                                                    <br>
                                                    <!--<a href="Documentos/Sem 08_Victor Manuel Cruz Mendoza.pdf" target="_blank">Ver archivo</a>-->
                                                    <a href="<?php echo e(str_replace('E:\xampp1\htdocs\intimark_sgd\public\Documentos', 'Documentos', $reporte->ruta_st7)); ?>"
                                                        target="_blank">Ver documento</a>
                                                </td>
                                                <td>
                                                    <?php echo e($reporte->formato_st3); ?>

                                                    <br>
                                                    <!--<a href="Documentos/Sem 08_Victor Manuel Cruz Mendoza.pdf" target="_blank">Ver archivo</a>-->
                                                    <a href="<?php echo e(str_replace('E:\xampp1\htdocs\intimark_sgd\public\Documentos', 'Documentos', $reporte->ruta_st3)); ?>"
                                                        target="_blank">Ver documento</a>
                                                </td>
                                                <td>
                                                    <?php echo e($reporte->formato_alta); ?>

                                                    <br>
                                                    <!--<a href="Documentos/Sem 08_Victor Manuel Cruz Mendoza.pdf" target="_blank">Ver archivo</a>-->
                                                    <a href="<?php echo e(str_replace('E:\xampp1\htdocs\intimark_sgd\public\Documentos', 'Documentos', $reporte->ruta_alta)); ?>"
                                                        target="_blank">Ver documento</a>
                                                </td>
                                            <?php endif; ?>
                                            <td>
                                                <?php echo e($reporte->fecha_registro); ?>

                                            </td>
                                            <td>
                                                <?php echo e($reporte->oficioentregado); ?>
                                            ...
                                            <?php if(auth()->user()->hasRole('Servicio Medico') ||
                                                ...
                                                <td class="float-center">
                                                    <a class="btn btn-info float-right"
                                                        href="<?php echo e(route('incapacidades.show', $reporte->id)); ?>"
                                            ...
                                            <?php if(auth()->user()->hasRole('Servicio Medico')): ?>
                                                <td class="float-center">
                                                    <a class="btn btn-danger float-right"
                                                        href="<?php echo e(route('cancelarincapacidad', $reporte->id)); ?>">Cancelar</a>
                                                </td>
                                            <?php endif; ?>
                                        </tr>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/incapacidades/reporte.blade.php ENDPATH**/ ?>