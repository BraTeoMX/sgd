                                ...
                                <?php if(isset($reportes)): ?>
                                    <?php $__currentLoopData = $reportes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reporte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo e($reporte->des_edo_neg); ?>

                                            </td>
                                            <td>
                                                <?php echo e($reporte->cvetra); ?>

                                            </td>
                                            <td>
                                                <?php echo e($reporte->nombre.' '.$reporte->paterno.' '.$reporte->materno); ?>

                                            </td>
                                            <td>
                                                <?php echo e($reporte->horario); ?>

                                            </td>
                                            <td>
                                                <?php echo e($reporte->cvepue); ?>

                                            </td>
                                            <td>
                                                <?php echo e($reporte->modulo); ?>

                                            </td>
                                            <td>
                                                <?php echo e($reporte->justificacion); ?>

                                            </td>
                                            <td>
                                                <?php echo e($reporte->permiso); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\intimark_sgd\resources\views/ausentismo/reporte.blade.php ENDPATH**/ ?>